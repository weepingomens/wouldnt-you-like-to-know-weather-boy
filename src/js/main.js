...
var $toggleHeaderButton = $("#header-toggle");
var $headerSelector = $("#omens-header");
var headerIsCollapsed;

function toggleSidebar() {

  headerIsCollapsed = !headerIsCollapsed;

  if ($headerSelector.hasClass('open-on-load')) {
    $headerSelector.removeClass('open-on-load');
    console.log('The \'open-on-load\' class has been removed.');
  ...
  if (headerIsCollapsed) {
    ...
    $headerSelector.removeClass('closed');
    ...
    $headerSelector.addClass('closed');
    localStorage.setItem('sidebar', 'closed');
    console.log('The \'closed\' storage item has been set.');
...
if (localStorage.getItem('sidebar') === null) {
  headerIsCollapsed = openSidebarOnLoad;
  console.log('The default state is ' + openSidebarOnLoad);
...
if (headerIsCollapsed) {
  $headerSelector.addClass('open-on-load');
  console.log('The \'open-on-load\' class has been added.');

}

$toggleHeaderButton.on('click', toggleSidebar);